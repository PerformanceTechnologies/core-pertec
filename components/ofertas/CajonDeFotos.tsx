    ...
    >
      ...
      <p className="mt-0.5 text-[11px] text-pretty text-tinta/45">
        {imagenes.length === 0
          ...
          : "Arrastrá una hasta la sección del documento donde va —o hasta la línea de firma o el hueco de logo del encabezado, según qué sea— y sacala con la × de cada foto. Podés soltar archivos acá o sobre el documento."}
      </p>
