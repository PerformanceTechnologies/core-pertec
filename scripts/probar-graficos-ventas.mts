...
// ── 8b. Al apuntar una porción, nada se sale del panel ─────────────────
//
...
}, await indiceDe("Dónde está la plata"));
...
// ── 8c. El tooltip de la dona tiene que verse ──────────────────────────
//
...
const indiceDona = await indiceDe("Dónde está la plata");
